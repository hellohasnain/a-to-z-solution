...
const cctv = () => {
    ...
    const services = [
        ...
        {
            title: '4 IP Camera installation',
            subtitle: 'Installation with 10 Feet pipe (1 to 2.5 tons)',
            originalPrice: 2999,
            discountedPrice: 2222,
            rating: 4.4,
        ...
        {
            title: '8 IP Camera Installation',
            subtitle: 'Installation With 3.5 Month Plan',
            originalPrice: 3499,
            discountedPrice: 2500,
            rating: 4.4,
        ...
        {
            title: '16 IP Camera installation',
            subtitle: 'Installation with 10 Feet pipe (1 to 2.5 tons)',
            originalPrice: 2999,
            discountedPrice: 2222,
            rating: 4.4,
        ...
        {
            title: '32 IP Camera installation',
            subtitle: 'Installation with 10 Feet pipe (1 to 2.5 tons)',
            originalPrice: 2999,
            discountedPrice: 2222,
            rating: 4.4,
        ...
        {
            title: '64 IP Camera installation',
            subtitle: 'Installation with 10 Feet pipe (1 to 2.5 tons)',
            originalPrice: 2999,
            discountedPrice: 2222,
            rating: 4.4,
            ...
            <div className="bg-blue-700 w-full">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="text-center md:text-left">
                        <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">CCTV Camera</h1>
                        <p className="text-lg sm:text-xl text-blue-100">
                            We Sell, Repair, and Install CCTV !
                        </p>
                    </div>
